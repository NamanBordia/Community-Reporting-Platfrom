        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Community Reporting</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Empowering communities to report and track local issues. 
              Help make your neighborhood better by reporting problems 
              and staying informed about their resolution.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Community Reporting Platform. All rights reserved.
            </p>
